...
. THRIFT should be able to hold up to 250 transactions without a noticeable sluggishness in performance for typical usage.
...
Stand for the field of work in which someone manages one or more systems, be they software, hardware, servers or workstations
