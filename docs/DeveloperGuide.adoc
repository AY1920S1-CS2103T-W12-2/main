...
`Main` has two classes called link:{repoURL}/srv/main/java/seedu/address/Main.java[`Main`] and link:{repoURL}/srv/main/java/seedu/address/MainApp.java[`MainApp`]. It is responsible for,
...
*API* : link:{repoURL}/srv/main/java/seedu/address/ui/Ui.java[`Ui.java`]

The UI consists of a `MainWindow` that is made up of parts e.g.`CommandBox`, `ResultDisplay`, `PersonListPanel`, `StatusBarFooter` etc. All these, including the `MainWindow`, inherit from the abstract `UiPart` class.

The `UI` component uses JavaFx UI framework. The layout of these UI parts are defined in matching `.fxml` files that are in the `srv/main/resources/view` folder. For example, the layout of the link:{repoURL}/srv/main/java/seedu/address/ui/MainWindow.java[`MainWindow`] is specified in link:{repoURL}/srv/main/resources/view/MainWindow.fxml[`MainWindow.fxml`]
...
*API* :
link:{repoURL}/srv/main/java/seedu/address/logiv/Logic.java[`Logic.java`]
...
*API* : link:{repoURL}/srv/main/java/seedu/address/model/Model.java[`Model.java`]
...
*API* : link:{repoURL}/srv/main/java/seedu/address/storage/Storage.java[`Storage.java`]
