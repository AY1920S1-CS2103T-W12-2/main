...
image::add-transaction/AddTransaction0.png[,350]
...
Step 3. The user executes **add_income n/Bursary v/500 r/Awarded for doing well in school** to insert an `**Income**`.
