...
****
* Deletes the transaction at the specified `EXPENSE_INDEX`.
* The index refers to the index number currently shown in the UI (after filtering, if any).
