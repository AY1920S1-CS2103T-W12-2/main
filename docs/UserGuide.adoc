...
Format: `convert f/ORIGIN_CURRENCY t/TARGET_CURRENCY (v/VALUE|i/INDEX)`
...
*   `convert f/SGD t/USD v/1000`

*   `convert f/SGD t/JPY i/8`
...
* <<ConvertTag, *Convert*>>: `convert f/ORIGIN_CURRENCY t/TARGET_CURRENCY (v/VALUE|i/INDEX)` +
Examples: +
 `convert f/SGD t/USD v/1000` +
 `convert f/SGD t/JPY i/8`
* <<UndoTag, *Undo*>>: `undo`
