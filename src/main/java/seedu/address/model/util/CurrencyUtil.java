...
public class CurrencyUtil {
    ...
    /**
     * Converts input currency amount from {@link seedu.address.model.transaction.Value#DEFAULT_CURRENCY} denomination
     * to the currency specified in the input.
     *
     * @param currencyMappings Mapping of currency rates scaling from
     *     {@link seedu.address.model.transaction.Value#DEFAULT_CURRENCY}.
    ...
    /**
     * Converts input currency amount to {@link seedu.address.model.transaction.Value#DEFAULT_CURRENCY} denomination
     ...
     * @return Amount in {@link seedu.address.model.transaction.Value#DEFAULT_CURRENCY} denomination as a double.
     */
